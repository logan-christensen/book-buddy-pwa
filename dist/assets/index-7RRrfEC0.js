...
Output exactly 3 questions, one per line, no numbering, no extra text.`;function Te(t){const n=x();t.innerHTML=`
    <div class="page">
      ...
      <div class="settings-body">
        ...
        <section class="settings-section">
          ...
          <label class="field">
            <span>API Key</span>
            <input type="password" id="s-anthropic" value="${I(n.anthropicKey)}" placeholder="sk-ant-…" autocomplete="off">
          </label>
        </section>
        ...
        <section class="settings-section">
          ...
          <label class="field">
            ...
            <input type="password" id="s-gh-token" value="${I(n.githubToken)}" placeholder="ghp_…" autocomplete="off">
          </label>
          <label class="field">
            <span>Owner</span>
            <input type="text" id="s-gh-owner" value="${I(n.githubOwner)}" placeholder="your-username">
          </label>
          <label class="field">
            <span>Repository</span>
            <input type="text" id="s-gh-repo" value="${I(n.githubRepo)}" placeholder="my-novel">
          </label>
          <label class="field">
            <span>Branch</span>
            <input type="text" id="s-gh-branch" value="${I(n.githubBranch)}" placeholder="main">
          </label>
        </section>
        ...
        <section class="settings-section">
          ...
          <label class="field">
            ...
            <input type="email" id="s-email" value="${I(n.emailAddress)}" placeholder="you@example.com">
          </label>
        </section>
  ...
  `,document.getElementById("s-save").addEventListener("click",()=>{ge({anthropicKey:L("s-anthropic"),githubToken:L("s-gh-token"),githubOwner:L("s-gh-owner"),githubRepo:L("s-gh-repo"),githubBranch:L("s-gh-branch")||"main",emailAddress:L("s-email")}),M("Settings saved")})}function L(t){return document.getElementById(t).value.trim()}function I(t){return t.replace(/"/g,"&quot;")}function M(t){const n=document.createElement("div");n.className="toast",n.textContent=t,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("toast-show")),setTimeout(()=>{n.classList.remove("toast-show"),setTimeout(()=>n.remove(),300)},2200)}async function Ae(t,n){t.innerHTML=`
